  ...
  template: `
    <div class="container mx-auto w-full py-4 md:px-2 px-4">
      <div class="flex items-center justify-between mb-2">
        <h1
          class="leading-tight tracking-tight text-xl font-semibold whitespace-nowrap p-2 dark:text-white"
        >
          Backups
        </h1>
        <button
          (click)="add()"
          type="button"
          class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-0 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
      ...
      <div class="relative overflow-x-auto shadow-md rounded-lg">
        ...
        >
          <thead
            class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-900 dark:text-slate-300"
          >
            <tr>
              <th scope="col" class="px-6 py-3">Name</th>
              <th scope="col" class="px-6 py-3">Folder</th>
              <th scope="col" class="px-6 py-3">Cron</th>
              <th scope="col" class="px-6 py-3">Connection String</th>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
              ...
              <td class="px-6 py-4">
                <span
                  ...
                  (click)="item.showString = !item.showString"
                >
                  <i
                    class="fa-solid mr-2"
                    [ngClass]="{
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
              <td colspan="5">
                <div class="flex items-center justify-center p-2">
                  <p
                    class="text-lg leading-7 px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                  >
                    No backups is setup. <b class="tracking-tighter">Setup!</b>
                  </p>
                </div>
              </td>
            </tr>
      ...
      <modal
        ...
        [closable]="true"
        *ngIf="formBackup"
        [backdropClass]="'backdrop-opacity-50'"
        (close)="cancel()"
      >
        <div class="px-3 pt-2">
          <form [formGroup]="formBackup">
            <div class="grid gap-2 sm:grid-cols-2 grid-cols-1">
              ...
              <div class="col">
                ...
                <input
                  placeholder="Ex: postgresql://postgres:password@localhost:5432/postgres"
                  type="text"
                  id="connectionString"
              ...
              <div class="col">
                <div class="flex items-center">
                  ...
                  <label
                    for="zip"
                    class="ms-2 text-sm font-medium select-none text-gray-900 dark:text-gray-300"
                    >Zip</label
                  >
                </div>
                <div class="flex items-center">
          ...
          <div
            class="py-3 px-2 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 transition duration-150 ease-out hover:ease-in"
            role="alert"
            *ngIf="!formBackup.get('continuos')?.value"
          >
            <span class="font-medium align-top text-start text-wrap">
              <i class="fa-solid fa-circle-exclamation fa-lg mr-2"></i>
              <span class="indent-8 tracking-tight font-thin">
                Setting continuos to <code>false</code> will run this backup
                once and it won't be listed at this listing.
              </span>
            </span>
          </div>

          <div
            class="py-3 px-2 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
            role="alert"
            *ngIf="message && message.trimEnd().length"
          >
          ...
          <div class="flex items-center justify-end gap-2 pt-4">
            <button
              (click)="cancel()"
              type="button"
              class="text-white disabled:cursor-not-allowed bg-red-700 disabled:bg-red-500 disabled:hover:bg-red-700 hover:bg-red-800 focus:ring-0 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center disabled:dark:bg-red-500 dark:bg-red-600 disabled:dark:hover:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
            >
              <i class="fa-solid fa-times mr-2"></i>
              Cancel
            </button>
            <button
              [disabled]="!formBackup.valid"
              (click)="save()"
              type="button"
              class="text-white disabled:cursor-not-allowed bg-green-700 disabled:bg-green-500 disabled:hover:bg-green-700 hover:bg-green-800 focus:ring-0 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center disabled:dark:bg-green-500 dark:bg-green-600 disabled:dark:hover:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
            >
              @if (!loading) {
              <svg
                class="w-5 h-5"
...
export class BackupComponent implements OnInit {
  ...
  save() {
    ...
    this.storageApi
      .post(this.editing ? 'api/updateBackup' : 'api/backup', value)
      .subscribe({
        next: (x) => {
          console.log(x);
